...
<div class="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-gray-50">
    <div class="max-w-lg w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <!-- Tombol Daftar -->
            <button type="submit" 
                class="w-full bg-emerald-500 hover:bg-emerald-600 text-white p-3 rounded-xl font-bold shadow-lg shadow-emerald-500/20 transition duration-200 text-sm mt-2">
                Daftar Akun
            </button>
        </form>
